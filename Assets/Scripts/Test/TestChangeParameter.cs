...
public class TestChangeParameter : MonoBehaviour
{
    ...
    {
        //Debug.Log("Awake");
        weight = GetComponent<TestTorque>().weight;
        length = GetComponent<TestTorque>().length;
        past_elbow_angle = GetComponent<TestTorque>().initialAngle;
